	...
	<body>
		...
		<div class="container">
			<div class="jumbotron">
				...
				<p>
					Consectetur unde eius ducimus esse obcaecati perferendis, ad veritatis quo, nostrum! Dolor consequuntur assumenda quisquam
					eos repellat Magni voluptates sed neque odio officiis? Laborum aliquid obcaecati eaque sint error Nam.
				</p>
				<p>
					<a class="btn btn-lg btn-primary" href="http://getbootstrap.com/docs/3.3/" role="button">
